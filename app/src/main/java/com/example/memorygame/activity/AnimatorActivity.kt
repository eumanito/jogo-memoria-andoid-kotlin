...
class AnimatorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            image1 = getRandomCharacterImage()
            image2 = getRandomCharacterImage()
            image3 = getRandomCharacterImage()
        }
    ...
    private suspend fun getRandomCharacterImage(): String {
        return try {
            val randomCharacter = characterService.getRandomCharacter()
